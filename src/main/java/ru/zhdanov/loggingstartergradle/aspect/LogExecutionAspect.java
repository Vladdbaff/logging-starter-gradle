package ru.zhdanov.loggingstartergradle.aspect;
...
import ru.zhdanov.loggingstartergradle.annotation.LogExecutionTime;
...
public class LogExecutionAspect {
    ...
    @Around("@annotation(ru.zhdanov.loggingstartergradle.annotation.LogExecutionTime)")
